...
function printInfo() {
    ...
    report = report.concat("\n" + "Hp Remaining Shadow (on win): " + round(info.averageRemainingHPShadow));
    report = report.concat("\n" + "Average Hits Free: " + round(info.averageHitsFree));
    report = report.concat("\n" + "Average Hits Shadow: " + round(info.averageHitsShadow));
    report = report.concat("\n" + "Average Presses: " + round((info.presses/info.total)));
    report = report.concat("\n" + "Average Dice Used by Attacker: " + round((info.diceUsed/info.total)));
